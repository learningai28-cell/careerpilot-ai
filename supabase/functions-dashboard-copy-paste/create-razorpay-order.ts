...
// Name the function exactly: create-razorpay-order
//
// Requires these Edge Function secrets:
//   RAZORPAY_KEY_ID           - Test Mode key to start
//   RAZORPAY_KEY_SECRET       - matching secret
//   RAZORPAY_PRO_PLAN_AMOUNT  - price in paise, e.g. 49900 for INR 499.00 (placeholder)

import { createClient } from "npm:@supabase/supabase-js@2.45.0";

const RAZORPAY_KEY_ID = Deno.env.get("RAZORPAY_KEY_ID")!;
const RAZORPAY_KEY_SECRET = Deno.env.get("RAZORPAY_KEY_SECRET")!;
const PRO_PLAN_AMOUNT = Deno.env.get("RAZORPAY_PRO_PLAN_AMOUNT") ?? "49900";
